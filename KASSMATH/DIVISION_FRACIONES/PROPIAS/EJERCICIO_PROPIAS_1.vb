Public Class EJERCICIO_PROPIAS_1
...
Dim divisor_1 As Integer = numero_random.Next(2, 10)
Dim numerador_2 As Integer = numero_random.Next(1, 10)
Dim divisor_2 As Integer = numero_random.Next(2, 10)
...
divisor_1 = numero_random.Next(1, 10)
...
Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
    Dim niveles_propias As New NIVELES_PROPIAS
    niveles_propias.Show()
    Me.Dispose()
End Sub
