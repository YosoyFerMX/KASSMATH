Public Class Impropias4

    Private Sub Impropias4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
 Dim frmImPropiasNiveles As New Impropias_Niveles
        frmImPropiasNiveles.Show()
        Me.Dispose()
End Sub
