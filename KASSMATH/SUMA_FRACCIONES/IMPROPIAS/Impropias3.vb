Public Class Impropias3

    Private Sub Impropias3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Numero_Azar = Random.Next(1, 6)

        Lbl_Den1.Text = Numero_Azar
        Do
            Numero_Azar = Random.Next(5, 10)
