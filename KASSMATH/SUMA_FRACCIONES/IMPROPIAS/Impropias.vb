Public Class Impropias

    Private Sub Impropias_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
Private Sub btn_continuar_Click(sender As Object, e As EventArgs) Handles btn_continuar.Click
        ...
        VariablesGlob.contador_impropia = VariablesGlob.contador_impropia + 1

        If (VariablesGlob.contador_impropia = 1 Or VariablesGlob.contador_impropia = 2) Then
            Dim frm_pregunta_2_4 As New Frm_Propias1()
