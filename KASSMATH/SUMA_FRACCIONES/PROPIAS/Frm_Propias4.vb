Public Class Frm_Propias4

    Private Sub Frm_Propias4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim Numero_Azar As Integer
        Dim Random As New Random()

        'Primer NUMERO FRACCIONARIO'

        Numero_Azar = Random.Next(15, 40)

        Lbl_Den1.Text = Numero_Azar
        Do
            Numero_Azar = Random.Next(10, 30)
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        Dim frmPropiasNiveles As New Frm_NivelesPropias
        frmPropiasNiveles.Show()
        Me.Dispose()
    End Sub
End Class