Public Class frmN1Propias

    

    Private Sub frmN1Propias_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
salida:
        azarpro1 = n1.Next(4, 9) 'Para el primer denominador
        azarpro2 = n2.Next(1, azarpro1) 'Para el primer numerador
        azarpro3 = n3.Next(2, 9) 'Para el segundo denominador
        azarpro4 = n4.Next(1, azarpro3) 'Para el segundo numerador
            ...
            If IsNumeric(Res1.Text) And IsNumeric(Res2.Text) And IsNumeric(MultDen.Text) And IsNumeric(txtReDen.Text) And IsNumeric(txtReNum.Text) Then
                ...
                Else
                    If fUsuario <> fsimple Then
                        VaGlobales.RNivel1 = 1
                    Else
                        VaGlobales.RNivel1 = 0
                    End If
                    If Res1.Text <> Resta1 Or Res2.Text <> Resta2 Or MultDen.Text <> MDenominadores Then
                        VaGlobales.ProcNivel1 = 1
                    Else
                        VaGlobales.ProcNivel1 = 0
                    End If
