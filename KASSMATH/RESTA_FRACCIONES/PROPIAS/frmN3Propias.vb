Public Class frmN3Propias


    Private Sub frmN3Propias_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
salida:
        ...
        azarpro1 = n1.Next(7, 9) 'Para el primer denominador
        azarpro2 = n2.Next(6, 8) 'Para el primer numerador
        azarpro3 = n3.Next(5, 8) 'Para el segundo denominador
        azarpro4 = n4.Next(1, 3) 'Para el segundo numerador
        azarpro5 = n5.Next(5, 9) 'Para el tercer denominador
        azarpro6 = n6.Next(1, 4) 'Para el tercer numerador
...
Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        'CICLO PARA OBTENER EL MÍNIMO COMÚN MÚLTIPLO'
            ...
            VaGlobales.ArrNiv3(0) = nm1
            VaGlobales.ArrNiv3(1) = nm2
            VaGlobales.ArrNiv3(2) = nm3
            VaGlobales.ArrNiv3(3) = dn1
            VaGlobales.ArrNiv3(4) = dn2
            VaGlobales.ArrNiv3(5) = dn3
            ...
            Do While dn1 <> 1 Or dn2 <> 1 Or dn3 <> 1
                ...
                uno = 0
            Loop
            VaGlobales.ArrNiv3(6) = mcp
            VaGlobales.VerifN1 = 0
            VaGlobales.ArrNiv3(7) = numfin
            VaGlobales.ArrNiv3(8) = denfin
